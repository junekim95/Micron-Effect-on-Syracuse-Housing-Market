...
a Difference-in-Differences design comparing Onondaga County against four comparable 
...
- Zillow ZHVI (home values): Download CSV at zillow.com/research/data — Geography: County
- Zillow ZORI (rent): Download CSV at zillow.com/research/data — Geography: County
...
- Control group is manually selected: counties chosen based on comparable size and economic structure, not statistical matching, since I realized my capability limitation as I started the project ... 
